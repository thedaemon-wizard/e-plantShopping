                    ...
                    <div key={index}>
                        ...
                        <div className="product-list">
                            ...
                            <div className="product-card" key={plantIndex}>
                                ...
                                {/* カート内のアイテム数に基づいてボタン表示を変更 */}
                                {isItemInCart(plant.name) ? (
                                    <div className="in-cart-indicator">
                                        <span>In Cart: {getItemQuantity(plant.name)}</span>
                                        <button className="product-button" onClick={() => handleAddToCart(plant)}>Add More</button>
                                    </div>
                                ) : (
